...
namespace Verifone.ECRTerminal
{
    internal partial class ECRProtocol : IDisposable
    {
        ...
        /// <summary>
        /// Sends a protocol message to the payment terminal and reports any error via <see cref="OnProtocolError"/>.
        /// This helper method centralizes the common pattern of sending a request and handling errors,
        /// reducing code duplication and improving maintainability.
        /// </summary>
        /// <param name="request">The protocol message to send.</param>
