...
namespace Verifone.ECRTerminal
{
    ...
    {
        /// <summary>
        /// Gets the name of the text encoding used for ECR protocol messages.
        /// </summary>
        ...
        /// </summary>
        /// <param name="transactionId">The transaction identifier or <see cref="ECRProtocol.SendRetrieveTransaction(string, DateTime)"/> for last.</param>
